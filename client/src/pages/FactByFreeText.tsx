...
const FactByFreeText: React.FC = () => {
  ...
  return (
    <section
      className='xs:max-w-[85%] xs:min-w-[85%] sm:max-w-[80%] sm:min-w-[80%] md:max-w-[70%] md:min-w-[70%] sm:landscape:min-w-[70%] sm:landscape:max-w-[70%] md:landscape:min-w-[60%] md:landscape:max-w-[60%] xl:landscape:min-w-[40%] xl:landscape:max-w-[40%] mt-4'
      aria-live="polite"
      aria-busy={loading}
    >
      <h2 className='uppercase font-semibold text-zinc-900/80 dark:text-zinc-200 text-center md:text-xl'>
